<?php
  ...
  if(isset($_POST['save'])){
    ...
    if($username != null ){
      $add_list = $point->insert_point($username, $thumbnail, $content);
    }
  }
...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
              <form class="row g-3" style="margin-top: 10px;" action="point_add.php" method="post" enctype="multipart/form-data">
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Tên điểm đến</label>
                  <input type="text" class="form-control" id="inputNanme4" name="namep">
                </div>
                <div class="col-md-12">
