<?php
  ...
  if(isset($_POST['adddt'])){
    ...
    if($tittle != null){
      $add_list = $blog->insert_blog($tittle, $seoname, $seodescription, $title_th, $alt_text, $description_th, $thumbnail, $caption_th, $content, $createdby);
    }
  }
...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
              <form class="row g-3" style="margin-top: 10px;" action="blog-add.php" method="post" enctype="multipart/form-data">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="inputName5" name="seoname">
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="inputName5" name="title_th">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" id="inputName5" name="caption_th">
                </div>
                <!-- <div class="col-md-6">
