...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Dữ liệu điểm đến</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
                      ...
                      <td class="text-right">
                          <div class="dropdown dropdown-action">
                              ...
                              <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                  <li><a class="dropdown-item" href="point_edit.php?id='.$dt['id'].'"><i class="ri-ball-pen-line"></i>  Sửa</a></li>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('deleteConfirmBtn').addEventListener('click', function () {
        ...
        // Gọi hàm xóa với id
        window.location.href ="point_delete.php?id=" +id;
    });
});
